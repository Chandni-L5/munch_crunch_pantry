...
| 1.4 | AC6 | Confirmation email sent | 1. Successfully reset password | Confirmation email received | ✅ |
...
| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 1.5 | AC1 | Password reset email sent | 1. Request reset | Reset email received | ✅ |
| 1.5 | AC2 | Order confirmation email sent | 1. Place an order | Email includes order summary | ✅ |
...
| 2.3 | AC2 | Only authenticated purchasers may review | 1. Try leaving review logged out<br>2. Try logged in without purchase<br>3. Try after purchasing | Only users who bought the product can leave a review | ✅ |
...
### User Story 2.5 — Discounts

| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 2.5 | AC1 | Promotions display correctly | Promo codes displayed in info banner | Promotional badges or pricing appear correctly | ✅ |
| 2.5 | AC2 | Promotional pricing correctly displayed | 1. View discounted product | Original price + discounted price shown clearly (e.g., strikethrough) | ⏳ |

### User Story 2.6 — Search for Products

| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 2.6 | AC1 | Search bar visible | 1. Open homepage | Search bar is visible on navigation or homepage | ✅ |
| 2.6 | AC2 | Search returns matching results | 1. Search for keyword matching a product | Correct products appear with image, price, brief info | ✅ |
| 2.6 | AC3 | No results message displays | 1. Search for gibberish term | “No products found” message displayed | ✅ |

### User Story 2.7 — Filter Products

| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 2.7 | AC1 | Filters are visible | 1. Open product listing page | Filters for price range, popularity, etc. are present | ✅ |
| 2.7 | AC2 | Filtering updates the product list | 1. Apply filter (e.g., price range) | Only products that match the filter are displayed | ✅ |


### User Story 2.8 — Admin Product Management

| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 2.8 | AC1 | Product management page accessible | 1. Log in as admin<br>2. Open Product Management | All products are visible in admin listing | ✅ |
| 2.8 | AC2 | Admin can add, edit, delete products | 1. Add product<br>2. Edit product<br>3. Delete product | Add = product appears on site<br>Edit = updates show<br>Delete = product removed | ✅ |
| 2.8 | AC3 | Restricted to admin users | Only admin users can access product management page | Access denied for non-admin users | ✅ |

### User Story 2.9 — Manage Product Images, Stock, Pricing

| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 2.9 | AC1 | Admin can update product metadata | 1. Log in as admin<br>2. Edit product image, description, stock, price<br>3. Save | Updates successfully saved in admin | ✅ |
| 2.9 | AC2 | Public site reflects admin updates | 1. View updated product page | Page shows latest image, stock level, price, description | ✅ |
| 2.9 | AC3 | Restricted to admin users | Only admin users can access product management page | Access denied for non-admin users | ✅ |
...
| 3.1 | AC5 | Bag persists during session | 1. Add items to bag<br>2. Navigate site<br>3. Return to bag | Items remain in bag throughout session | ✅ |
...
| 4.1 | AC2 | Brand values, sourcing and benefits clearly displayed | 1. Open About page<br>2. Read content | Information on brand values, sourcing, health benefits is present and clear | ✅ |

### User Story 4.2 — View Certifications on Product Pages

| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 4.2 | AC1 | Certifications are displayed on product pages | 1. Assign certifications to a product in admin<br>2. Open product page | Eco-friendly / fair-trade badges appear alongside product info | ⛔️ |

### User Story 4.3 — Admin Content Management

| US ID | AC ID | Description | Test Steps | Expected Result | Pass/Fail |
|-------|-------|-------------|------------|-----------------|-----------|
| 4.3 | AC1 | Admin can add/edit content | 1. Log in as admin<br>2. Open admin dashboard, 2.add a new story, 3. edit and existing story | Content /change immediately updates | ✅ |
...
| 4.3 | AC3 | Restricted to admin users | Only admin users can access product management page | Access denied for non-admin users | ✅ |
...
| 4.5 | AC4 | Restricted to admin users | Only admin users can access product management page | Access denied for non-admin users | ✅ |