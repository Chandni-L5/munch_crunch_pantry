...
class OrderLineItem(models.Model):
    ...
    product_quantity = models.ForeignKey('products.ProductQuantity', null=False, blank=False, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f'SKU {self.product_quantity.sku} on order {self.order.order_number}'
